...
KEY_GENERAL_BOOK = 'book'
KEY_GENERAL_VOLUME = 'volume'
KEY_GENERAL_PART = 'part'
...
JSON_KEY_GENERAL_BOOK = KEY_GENERAL_BOOK
JSON_KEY_GENERAL_VOLUME = KEY_GENERAL_VOLUME
JSON_KEY_GENERAL_PART = KEY_GENERAL_PART
