...
#        widget = collector_B.getWidget(1)
        ...
        pathCollector = PathsCollector('A_folder_name', "/path/to/ini", "/path/to/jpeg")
        mainCollector = MediaCollector(pathCollector, titles_BB, control_BB)

        mainCollector = input_output.collectCardsFromFileSystem("/home/akoel/tmp/media", None) 
