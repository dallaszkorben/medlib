...
#        widget = storage_BC.getlWidget(1)
#        widget = collector_B.getlWidget(1)
...
#        mediaToShow = media_list[0]
        ...
        self.widget = mediaToShow.getlWidget(self.scale)
...
#        print(par)
    ...
    def goesDeeper(self, mediaCollector):        
        ...
        if mcl:
            ...
            self.widget = mts.getlWidget(self.scale)
            self.layout.addWidget(self.widget)
        elif msl:
            self.layout.removeWidget(self.widget);
            msl = msl[0]
            self.widget = msl.getlWidget(self.scale)
            self.layout.addWidget(self.widget)
