...
from medlib.input_output import CardListJson
from medlib.input_output import collectCardsFromJson
...
#        widget = collector_B.getWidget(1)
        ...
        if not jsonForm:            
            ...
            mainCollector = input_output.collectCardsFromJson(jsonForm)
