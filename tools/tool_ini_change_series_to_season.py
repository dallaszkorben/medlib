...
#            print(".", end="")
        ...
        #--- GENERAL --- #
        print(".", end="")
        series = card_ini.get(SECTION_GENERAL, "series", "", False)
        if series:        
            card_ini.update(SECTION_GENERAL, "season", series)
            card_ini.removeOption(SECTION_GENERAL, "series")
...
#    fixCards(paths)
    ...
    paths = "/media/akoel/Movies/Final/01.Video"
    fixCards(paths)
